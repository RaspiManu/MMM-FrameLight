...
(function (global, factory) {
  ...
  function getWheelHandlePosition(props, color) {
    ...
    if (handleDist < handleRange + 1) {
      handleDist = handleRange + 1;
    }
  ...
  function getBoxValueFromInput(props, x, y) {
    var _getBoxDimensions = getBoxDimensions(props),
        width = _getBoxDimensions.width/2,
        height = _getBoxDimensions.height/2,
  ...
  function IroBox(props) {
      ...
      return (h(IroComponentWrapper, Object.assign({}, props, { onInput: handleInput }), function (uid, rootProps, rootStyles) { return (h("svg", Object.assign({}, rootProps, { className: "IroBox", width: width, height: height, style: rootStyles }),
          ...
          h("rect", { className: "IroBoxBg", rx: radius, ry: radius, x: props.borderWidth, y: props.borderWidth, width: width - props.borderWidth, height: height - props.borderWidth, "stroke-width": props.borderWidth*2, stroke: props.borderColor, fill: ("url(" + (resolveSvgUrl('#f' + uid)) + ")") }),
